...
Original file is located at
    https://colab.research.google.com/drive/1Iz_xc1wfKGYyPDgjyXdJc6rgQrab0D_t
"""
...
aux = {x:list() for x in range(0, 10)}
...
def sort_step(to_sort):
    ...
    while count < _length:
        ...
        for element in clone:
            aux[_get(element, count)].append(element)
        clone = reduce(lambda i, j: i+j, aux.values(), [])
        count += 1
        # print(clone)
        # print(aux)
    _sorted_list = clone
